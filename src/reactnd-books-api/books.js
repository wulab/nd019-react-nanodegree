  ...
  if (searchWhitelist === undefined) {
    ...
    for (let word of searchWhitelistBase) {
      for (let j = 1; j <= word.length; ++j) {
        searchWhitelist[word.substring(0,j).toLowerCase()] = word.toLowerCase();
      }
    }
  }
